...
class cheaaSpider(CrawlSpider):
    ...
    def parse_ccontent(self,response):
        for url in response.xpath('//*[@id="main-l1"]'):
            ...
            item['ArtcleContent']=SpanContent+EmContent+PContent+CenterContent+DivContent
        ...
        next_content_page=url.xpath('//*[@id="main-l1"]/div[8]/table/tbody/tr/td[5]/a/@href').extract()[0]
